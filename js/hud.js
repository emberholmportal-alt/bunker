// EL BÚNKER — HUD: stats, recursos, inventario y mapa
  ...
  const SDEF=[['hambre','HAMBRE','🍖','#ffb000'],['sed','SED','💧','#39c4ff'],['energia','ENERGÍA','⚡','#8fffb0'],['cordura','CORDURA','🧠','#ff2e88']];
  ...
  const HB=[['food','hambre','COMER'],['water','sed','BEBER'],['med','cordura','MEDICARSE']];
  const invEl=$('#inv');
  ...
  function drawMapPlan(px,pz,yaw){
    ...
    x.fillStyle='#8fffb0';x.shadowColor='#8fffb0';x.shadowBlur=5;x.font='11px VT323, monospace';x.textAlign='left';x.fillText('PLANO — REFUGIO 048',7,12);x.shadowBlur=0;
    ...
    lab('OBSERVATORIO',0,-1.2);lab('BIBLIO',-1.2,6.4);lab('CULTIVO',0,10);lab('TALLER',5.4,7.0);lab('DESCANSO',-5.4,7.0);
